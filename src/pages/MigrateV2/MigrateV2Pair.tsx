...
import { FeeAmount, Pool, Position, priceToClosestTick, TickMath } from '@intrinsic-network/intrinsic-sdk'
import { CurrencyAmount, Fraction, Percent, Price, Token } from '@intrinsic-network/sdk-core'
        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <ThemedText.DeprecatedBlue display="inline">
              <Trans>Intrinsic migration contract↗</Trans>
        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Intrinsic pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.DeprecatedBody fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Intrinsic at a price you believe is correct. <br />
