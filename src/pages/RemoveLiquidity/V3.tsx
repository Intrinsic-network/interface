...
function Remove({ tokenId }: { tokenId: BigNumber }) {
  ...
  return (
    <AutoColumn>
      ...
      />
      <AppBody maxWidth={"700px"} width={"700px"}>
        <AddRemoveTabs
          creating={false}
          adding={false}
        ...
        <Wrapper>
          {position ? (
            <AutoColumn gap="lg">
              ...
              <LightCard style={{ padding: "23px 26px 23px 26px" }}>
                <AutoColumn gap="md">
                  <RowBetween>
                  ...
                  <AutoRow gap="6px" justify="flex-start">
                    <SmallMaxButton
                      onClick={() => onPercentSelect(0)}
                      width="107px"
                    >
                      <Trans>0%</Trans>
                    </SmallMaxButton>
              ...
              {showCollectAsWeth && (
                ...
                >
                  <ThemedText.DeprecatedBlack fontSize={20} fontWeight={600}>
