...
export default function Landing() {
  ...
  const showUnlockVoting = Boolean(
    intBalance && JSBI.notEqual(intBalance.quotient, JSBI.BigInt(0)) && userDelegatee === ZERO_ADDRESS
  )
      ...
      <Trace page={PageName.VOTE_PAGE} shouldLogImpression>
        <PageWrapper gap="lg" justify="center">
                ...
                <AutoColumn gap="md">
                  ...
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>
                        INT tokens represent voting shares in Intrinsic governance. You can vote on each proposal
            ...
            <WrapSmall>
              ...
              <AutoRow gap="6px" justify="flex-end">
                ...
                {showUnlockVoting ? (
                  ...
                  <ThemedText.DeprecatedBody fontWeight={500} mr="6px">
                    <Trans>
                      <FormattedCurrencyAmount currencyAmount={intBalance} /> Votes
                    </Trans>
                  </ThemedText.DeprecatedBody>
                ) : (
                  ''
          ...
          <ThemedText.DeprecatedSubHeader color="text3">
            <Trans>A minimum threshold of 0.25% of the total INT supply is required to submit proposals</Trans>
