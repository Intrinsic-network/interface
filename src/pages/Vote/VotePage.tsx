...
export default function VotePage() {
  ...
  const { id } = useParams() as { governorIndex: string; id: string };
  const parsedGovernorIndex = Number.parseInt("0");
            ...
            <RowBetween style={{ width: "100%" }}>
              <ArrowWrapper to="/vote">
                ...
                <ThemedText.DeprecatedLargeHeader
                  style={{ marginLeft: ".5rem", marginBottom: "3px" }}
                >
                  {proposalData?.title}
                </ThemedText.DeprecatedLargeHeader>
              </ArrowWrapper>
            ...
            <AutoColumn gap="10px" style={{ width: "100%" }}>
              ...
              {proposalData && proposalData.status === ProposalState.ACTIVE && !showVotingButtons && (
                <BlueCard>
                  ...
                  >
                    <Trans>
                      Only INT votes that were self delegated or delegated to
