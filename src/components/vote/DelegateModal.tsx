...
export default function DelegateModal({ isOpen, onDismiss, title }: VoteModalProps) {
  ...
  const uniBalance = useTokenBalance(account ?? undefined, chainId ? INT[chainId] : undefined)
        ...
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <ThemedText.DeprecatedBody>
              <Trans>Earned INT tokens represent voting shares in Intrinsic governance.</Trans>
            </ThemedText.DeprecatedBody>
            <ThemedText.DeprecatedBody>
