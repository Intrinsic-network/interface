...
export default function ProposalEmptyState() {
  ...
  if (chainId && chainId !== SupportedChainId.RSK_TESTNET) {
    return (
      <EmptyState
        HeaderContent={() => <Trans>Please connect to RSK Mainnet</Trans>}
        SubHeaderContent={() => (
          <Trans>
            Intrinsic governance is only available on RSK Mainnet. Switch your network to RSK Mainnet to view Proposals
            and Vote.
          </Trans>
        )}
      />
