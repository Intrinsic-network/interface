...
const Option = styled(FancyButton)<{ active: boolean }>`
  ...
  background-color: ${({ active, theme }) =>
    active && theme.secondaryButtonColor};
  color: ${({ active, theme }) =>
    active ? theme.deprecated_white : theme.deprecated_text1};
`;
...
const Input = styled.input`
  ...
  color: ${({ theme, color }) =>
    color === "red" ? theme.deprecated_red1 : theme.deprecated_text1};
  text-align: right;
...
const OptionCustom = styled(FancyButton)<{
  ...
  border: ${({ theme, active, warning }) =>
    active
      ? `1px solid ${
          warning ? theme.deprecated_red1 : theme.secondaryButtonColor
        }`
  ...
  :hover {
    border: ${({ theme, active, warning }) =>
      ...
      `1px solid ${
        warning
          ? darken(0.1, theme.deprecated_red1)
          : darken(0.1, theme.secondaryButtonColor)
      }`};
  }
